package com.linknote.server.security.config;


import com.linknote.server.security.filter.ExceptionHandlerFilter;
import com.linknote.server.security.filter.JwtAuthenticationFilter;
        ...
        http
                .cors().configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        config.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://*.linklabs.app"));
